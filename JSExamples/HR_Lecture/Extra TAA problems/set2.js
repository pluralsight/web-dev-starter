...
//     if(items[i].type === 'homegoods'){
//       bins.homegoods.push(items[i].item)
//     }
//      if(items[i].type === 'electronics'){
//       bins.electronics.push(items[i].item)
//     }
//      if(items[i].type === 'skincare'){
//       bins.skincare.push(items[i].item)
//     }
//   }
// console.log(bins)
// }
...
//     if(arr[i].action === 'brought the paper'){
//       accSum++
//     }
//   }
// return accSum
  ...
  function killerRobots(arr) {
   ...
   var boopSum = 0;
    ...
    for (let i = 0; i < arr.length; i++){
      ...
      //if(beepSum >= 4 && boopSum >= 4){
      if(beepSum % 2 === 0 && boopSum % 2 === 0){
        accArr.push(true)      
      } else {
        accArr.push(false)
      }
