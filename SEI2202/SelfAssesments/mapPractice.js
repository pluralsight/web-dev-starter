...
Tree.prototype.map(mappingFunc) {
  //instantiate a new node and set equal to passed in node value
  ...
  //loop through each child in "this" nodes array
    //pass each child node into mapping function
    //push returned result into copyNode array
