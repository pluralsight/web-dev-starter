...
A predicate is a function that takes one item as input and returns either true or false based on whether the item satisfies some condition. They're quite useful for interrogating objects to learn more about them or to apply certain operations conditionally to objects. Because Javascript supports passing around functions as values we can make predicate combinators: functions that build new predicates from simpler ones. This style of programming is sometimes called the combinator pattern, because it emphasizes creating systems by making the simple primitives first, then making tools for combining them into more complex objects. As an example, consider this function:
